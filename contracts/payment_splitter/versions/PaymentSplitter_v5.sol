...
/// @custom:version faulty implementation with a parenthesis error in `pendingPayment`
...
contract PaymentSplitter {
    ...
    function pendingPayment(
        ...
        // return (totalReceived * shares[account]) / totalShares - alreadyReleased; //correct implementation
        return
            totalReceived * (shares[account] / totalShares) - alreadyReleased; // dividing first leads to truncation issues
    }
