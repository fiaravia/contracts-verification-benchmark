...
/// @custom:version `join()` requires the player to transfer an amount strictly greater than the initial pot
...
contract PriceBet {
    ...
    // join allows a player to join the bet. This requires the player to deposit an amount of ETH greater to the initial pot.
    function join() public payable {
        require(msg.value > initial_pot, "Player must deposit an amount greater than the initial pot to join");
